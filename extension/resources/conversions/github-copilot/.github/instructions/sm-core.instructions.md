...
**SM PHẢI đọc `.opencode/rules/sdlc/loop-constraints.md` trước Step 0.** Verify all constraints are loaded. If file missing → warn user but continue (non-blocking).
