---
name: 'Pattern Catalog — Architecture Pattern Detection'
description: 'Pattern Catalog — Architecture Pattern Detection'
applyTo: '**'
---
...
|-----------|---------|--------|
| ai-agent | `.opencode/agents/*.md`, `.opencode/rules/sdlc/*.md`, prompt files, tool definitions | 0.9 |
