...
**When in bug fix mode, DEV MUST follow the 6-phase diagnosis loop** (see `.claude/rules/dev-bug-diagnosis.md`):
...
Read full procedure: `.claude/rules/dev-bug-diagnosis.md`
