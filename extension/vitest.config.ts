...
export default defineConfig({
  ...
  test: {
    ...
    exclude: [
      ...
      "src/__tests__/addon-download-helpers.test.ts",
      "src/__tests__/remote-backend-health.test.ts",
      "src/services/__tests__/indexer-http-proxy.test.ts",
      "src/webview/__tests__/chat-store.test.ts",
      "src/auth/__tests__/auth-manager.test.ts",
    ],
    globals: false,
    environment: "node",
