...
try {
  ...
  DevTools.Formatter.FormatterWorkerPool.FormatterWorkerPool.instance({
      forceNew: true,
      entrypointURL: typeof import.meta?.resolve === 'function'
          ? import.meta.resolve('./third_party/devtools-formatter-worker.js')
          : '',
  });
} catch (_devToolsInitErr) {
  // Non-fatal: DevTools frontend stubs don't support full init
}
