...
export class ParallelExecutor {
  ...
  constructor(
    private fanOutNode: FanOutNode = new FanOutNode(),
    private concurrency = ParallelExecutor.DEFAULT_CONCURRENCY,
    private timeoutMs = ParallelExecutor.DEFAULT_TIMEOUT_MS,
  ) {
