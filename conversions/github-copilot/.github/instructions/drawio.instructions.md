...
**Rules:**
1. MUST use **absolute path** (e.g., `./documents/{TICKET}/diagrams/use-case.drawio`)
...
```json
{
  "tool_name": "export_drawio",
  "arguments": {
    "file_path": "./documents/{TICKET}/diagrams/architecture.drawio",
    "format": "png"
  }
}
```
