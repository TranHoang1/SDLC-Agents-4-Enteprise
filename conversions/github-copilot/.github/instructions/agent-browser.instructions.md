---
name: 'Always consider agent-browser (vercel-labs) for ANY web task: deep web research, investigating/gathering information online, scraping, reading rendered or login-protected pages, browser automation, testing, or site/app interaction. Native Rust CLI — snapshots, clicks, fills, screenshots, JS eval, auth reuse, network inspection, and AI chat. Prefer it over a plain fetch when the task needs rendering, interaction, a logged-in session, or multi-step navigation.'
description: 'Always consider agent-browser (vercel-labs) for ANY web task: deep web research, investigating/gathering information online, scraping, reading rendered or login-protected pages, browser automation, testing, or site/app interaction. Native Rust CLI — snapshots, clicks, fills, screenshots, JS eval, auth reuse, network inspection, and AI chat. Prefer it over a plain fetch when the task needs rendering, interaction, a logged-in session, or multi-step navigation.'
applyTo: '**'
---
