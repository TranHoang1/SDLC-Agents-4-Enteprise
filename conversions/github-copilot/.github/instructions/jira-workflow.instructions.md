---
name: 'Jira integration rules — transitions, comments, attachments for SDLC pipeline'
description: 'Jira integration rules — transitions, comments, attachments for SDLC pipeline'
applyTo: '**'
---
